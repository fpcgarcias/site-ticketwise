          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Link to="/" className="flex items-center">
                ...
                <span className="text-xl font-bold text-gray-900">Ticket Wise</span>
              </Link>
            </div>
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(subscription?.subscription_status || '')}`}>
                      {getStatusText(subscription?.subscription_status || 'Sem assinatura')}
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  {product && (
                    <p className="text-sm text-gray-500 mt-1">
                      {formatCurrency(product.price.monthly)}/mês
                    </p>
                  )}
                </div>
              ...
              <div className="px-6 py-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <span className={`mt-1 inline-flex px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(subscription?.subscription_status || '')}`}>
                      {getStatusText(subscription?.subscription_status || 'Sem assinatura')}
                    </span>
                  </div>
                  <div>
