...
const TermsPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Termos de Serviço - Ticket Wise | Condições de Uso</title>
        <meta name="description" content="Termos de serviço do Ticket Wise. Conheça as condições de uso, direitos e responsabilidades da plataforma de gestão de chamados." />
        <link rel="canonical" href={`${baseUrl}/terms`} />
        
        <meta property="og:title" content="Termos de Serviço - Ticket Wise | Condições de Uso" />
        <meta property="og:description" content="Termos de serviço do Ticket Wise. Conheça as condições de uso, direitos e responsabilidades da plataforma de gestão de chamados." />
        <meta property="og:url" content={`${baseUrl}/terms`} />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={`${baseUrl}/og-image.jpg`} />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Termos de Serviço - Ticket Wise | Condições de Uso" />
        <meta name="twitter:description" content="Termos de serviço do Ticket Wise. Conheça as condições de uso, direitos e responsabilidades da plataforma de gestão de chamados." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Termos de Serviço - Ticket Wise",
            "description": "Termos e condições de uso da plataforma Ticket Wise, incluindo direitos, responsabilidades e políticas de uso.",
            "url": `${baseUrl}/terms`,
